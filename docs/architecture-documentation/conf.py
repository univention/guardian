...
def read_version_from_ci() -> str:
    ...
    with open("../.gitlab-ci.yml", "r") as f:
        ci = yaml.safe_load(f)
        return ci.get("variables", {"DOC_TARGET_VERSION": "0.0.1"}).get(
            "DOC_TARGET_VERSION"
        )
...
project = "Guardian Architecture Manual {}".format(release)
...
# the wrong file.
doc_basename = "architecture-documentation"
...
univention_doc_basename = "architecture-documentation"
