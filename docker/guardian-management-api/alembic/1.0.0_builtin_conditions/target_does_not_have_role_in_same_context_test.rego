package univention.target_does_not_have_role_in_same_context_test

import data.guardian.conditions.condition
import future.keywords.every
import future.keywords.if

target_does_not_have_role_in_same_context_parametrize := [
	{
		"condition_data": {
			"actor": {},
			"actor_role": {},
...
test_target_does_not_have_role_in_same_context if {
	every case in target_does_not_have_role_in_same_context_parametrize {
		result := condition(
			"guardian:builtin:target_does_not_have_role_in_same_context",
			case.parameters,
			case.condition_data,
		)
